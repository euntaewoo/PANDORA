...
| 에이전트 | 스킬 경로 | 권한 범위 |
|---|---|---|
| **Graphify** | .agents/skills/graphify/ | 읽기 전용 (분석) |
...
3순위: [프로젝트]/.agents/rules/agents.md
4순위: [프로젝트]/.agents/workflows/maestro.md
...
---
*로컬 경로: C:\Users\euntaewoo\.agents\harness\HARNESS.md*
