...
def test_pipeline():
    ...
    for lang in ["EN", "JP", "CN", "TW"]:
        prompt_txt, banned_patterns = load_dynamic_compliance_lexicon(lang)
        print(f"[{lang}] Loaded {len(banned_patterns)} active replacement rules. Prompt length: {len(prompt_txt)} chars.")
