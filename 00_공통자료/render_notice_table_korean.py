...
def load_credentials():
    ...
    if not os.path.exists(os.path.join(project_root, "00_공통자료")):
        project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "다국어_이미지_번역"))

    key_candidates = [
        os.environ.get("GOOGLE_APPLICATION_CREDENTIALS"),
        r"C:\Users\euntaewoo\Desktop\다국어_이미지_번역\00_공통자료\APIs_KEY\인증키_및_계정\김차장_vertex api_key\vertex_ai_auth_key.json",
