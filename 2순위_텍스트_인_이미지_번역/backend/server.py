...
def get_genai_client():
    auth_key_path = Path("C:/Users/euntaewoo/Desktop/multilingual_text_in_image_translatio_agy_sdk/00_공통자료/인증키_및_계정/김차장_vertex api_key/vertex_ai_auth_key.json")
