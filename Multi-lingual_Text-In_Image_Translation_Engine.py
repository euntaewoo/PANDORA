"""
===================================================================================
🌐 Multi-lingual_Text-In_Image_Translation_Engine.py
-----------------------------------------------------------------------------------
...
# =================================================================================
def main():
    parser = argparse.ArgumentParser(description="Multi-lingual_Text-In_Image_Translation_Engine")
    ...
    if not chosen_lang:
        ...
        print("\n" + "=" * 76)
        print(" 🌐 Multi-lingual_Text-In_Image_Translation_Engine")
        print("=" * 76)
