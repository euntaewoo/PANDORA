...
> **버전**: v1.2 | **작성일**: 2026-05-08 | **기준 PC**: 테스트탑 (신규 중고PC) | **기준 드라이브**: C드라이브
...
| **CREW** | 코드 직접 작성·수정 | `01_Maestro/` |
| **EVALUATOR** | 품질 검수 (100% Pass까지) | `01_Maestro/SOP_Dev_Quality_Gate.md` |
...
4순위: [프로젝트]\.agent\rules\Typography_Design_System.md
5순위: [프로젝트]\.agent\workflows\maestro.md
6순위: graphify-out\GRAPH_REPORT.md
```
