...
### 8️⃣ 고시정보표 4대 법률 표준화 및 MFDS 식약처 관할 명시
- 고시정보표 렌더링 및 DOCX 파싱 시 `standardize_notice_table_items` 공통 게이트를 통과하여 한국 식약처(MFDS) 기능성 심사필, 주의사항 3대 조항, 공정위 소비자분쟁기준, +82 고객상담번호가 5개 언어별로 100% 자동 매핑됨.
