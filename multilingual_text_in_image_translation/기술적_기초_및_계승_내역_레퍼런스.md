...
| **다국어 고시표 렌더러** | `00_공통자료/render_notice_table_standard.py` | `multilingual_text_in_image_translation.py` 내부 `render_notice_table()` 연동 |
| **한국어 원본 고시표 렌더러** | `00_공통자료/render_notice_table_korean.py` | `multilingual_text_in_image_translation.py` 내부 한국어 원본 생성 파이프라인 연동 |
