...
>   - `T = 0.6`: 일본 화장품 광고법(후생노동성 MHLW 약기법 및 56종 공인 효능 리스트) 위반 리스크 차단과 @cosme·큐텐재팬급 럭셔리 초월번역(Transcreation) 감성 품질 간의 **최적 균형점(황금 비율)**.
...
- **② 일본 약기법 광고법 무결성 (30점)**: 일본 후생노동성(MHLW) 약기법 56종 공인 효능 범위 외 의약품 오인 표현 100% 차단
