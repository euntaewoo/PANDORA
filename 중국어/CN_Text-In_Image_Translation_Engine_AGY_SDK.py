...
async def generate_seo_geo_aeo_txt(client: genai.Client, current_source_dir: str, target_dir: str, target_lang: str, product_name: str):
    ...
    lexicon_rules_text = ""
    lexicon_map = {
        "CN": "cn_nmpa_adlaw_lexicon.json",  # 🇨🇳 중국 본토 간체자 (NMPA 신광고법)
        "TW": "tw_tfda_lexicon.json",        # 🇹🇼 대만/홍콩 번체자 (TFDA 광고법)
        "HK": "tw_tfda_lexicon.json"         # 🇭🇰 홍콩 번체자
    }
    ...
    lang_names = {
        "CN": "Simplified Chinese for Tmall / Xiaohongshu (중국 대륙 간체자)",
        "TW": "Traditional Chinese for Shopee Taiwan / Momo (대만/홍콩 번체자)",
        "HK": "Traditional Chinese for Hong Kong (홍콩 번체자)"
    }
